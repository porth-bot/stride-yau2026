...
Runtime is roughly 2–4 minutes, dominated by Test 5 (the 60,000-probe exactness check).
...
| 3 | Redundancy ratio `N_f N / M` across 1-, 2-, and 4-year baselines vs. the closed form | Theorem 4.10 |
| 4 | In-transit count equals arrangement depth at a test hypothesis | Lemma 4.1 |
| 5 | Recovery of an injected transit; 60k random probes fail to beat the optimum; SR is constant within candidate intervals | Lemma 4.13 |
